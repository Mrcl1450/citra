...
const Interface::FunctionInfo FunctionTable[] = {
    {0x00010002, IPC::Wrap<decltype(Initialize), Initialize, const IPC::CallingPidParam&>,             "Initialize"},
    {0x00020000, IPC::Wrap<decltype(GetProcSemaphore), GetProcSemaphore>,                              "GetProcSemaphore"},
    {0x00030100, nullptr,             "RegisterService"},
    {0x000400C0, nullptr,             "UnregisterService"},
    {0x00050100, IPC::Wrap<decltype(GetServiceHandle), GetServiceHandle, const char(&)[8], u32, u32>,  "GetServiceHandle"},
